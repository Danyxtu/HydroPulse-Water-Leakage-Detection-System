...
export default function DetectionModal({ visible, onClose }: DetectionModalProps) {
  ...
  const renderZoneRow = (name: string, status: 'loading' | 'leak' | 'clear') => (
    <View style={styles.zoneRow} key={name}>
      ...
      <View style={styles.statusIconContainer}>
        {status === 'loading' && <ActivityIndicator size="large" color="#67A1EB" />}
        {status === 'leak' && (
  ...
  const renderStep1 = () => (
    <View style={styles.innerContainer}>
      ...
      <Text style={styles.titleText}>HydroPulse Water Leakage Detection System</Text>
  ...
  const renderStep2 = () => (
    <View style={styles.innerContainer}>
      ...
      <Text style={styles.titleText}>In preparation for scanning, please ensure the following:</Text>
  ...
  const renderStep3 = () => (
    <View style={styles.innerContainer}>
      <Text style={[styles.titleText, { color: '#67A1EB', fontSize: 22 }]}>Detecting...</Text>
      ...
      <View style={styles.btnDisabledWideContainer}>
        <View style={styles.btnDisabledWide}>
          <Text style={styles.btnDisabledWideText}>Detection in process...</Text>
        </View>
      </View>
    </View>
  );
  ...
  const renderStep4 = () => (
    <View style={styles.innerContainer}>
      <Text style={[styles.titleText, { color: '#EF4444', fontSize: 18 }]}>1 Possible Leakage is detected!</Text>
      ...
      <Text style={styles.warningText}>
        Upon exiting, immediately check the passageway of the area that is detected for possible water leakage to avoid any issues or damage.
      </Text>
      ...
      <View style={styles.buttonRowSpaced}>
        ...
        <TouchableOpacity onPress={handleClose} style={{ justifyContent: 'center', paddingHorizontal: 10 }}>
